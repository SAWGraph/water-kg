...
| ISGS Aquifer | Description | Lift to graph |
| --- | --- | --- |
| CODE | 0 - Not a potential aquifer <br/> 1 - Potential aquifer (only potential aquifers are instantiated in SAWGraph) | No |
