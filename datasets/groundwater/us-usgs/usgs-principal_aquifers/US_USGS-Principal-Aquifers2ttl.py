...
### INPUT Filenames ###
aquifers_file = data_dir / f"US_Aquifers/us_aquifers_no-other.shp"

### OUTPUT Filename ###
ttl_file = ttl_dir / f"us_usgs-principal-aquifers.ttl"

logname = log_dir / f"log_US_USGS-Principal-Aquifers2ttl.txt"
...
def build_iris(objectid, _PREFIX):
    ...
    """
    base_iri = f'd.USGS_PrincipalAquifer_{str(objectid).zfill(4)}'
