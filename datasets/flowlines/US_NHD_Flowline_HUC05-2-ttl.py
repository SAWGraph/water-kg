...
### INPUT Filenames ###
flowplus_file = r'../Geospatial/HUC05/MS_05_NHDPlusAttributes/PlusFlow.dbf'
flowline_file = r'../Geospatial/HUC05/MS_05_NHDSnapshot/NHDFLowline.shp'

### OUTPUT Filenames ###
main_ttl_file = 'ttl_files/us_nhd_flowline_huc05.ttl'
# headoutlet_ttl_file = 'us_nhd_flowline_huc05_headoutlet.ttl'

logname = 'logs/log_US_NHD_Flowline_HUC05-2-ttl.txt'
