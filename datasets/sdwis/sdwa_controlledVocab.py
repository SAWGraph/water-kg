...
## namespaces
ontologyIRI = URIRef('http://sawgraph.spatialai.org/v1/us-sdwis')
prefixes = {}
...
def triplify(codes):
    ...
    for idx, row in facility_type.iterrows():
        ...
        kg2.add((iris['type'], RDFS.isDefinedBy, ontologyIRI))
    ...
    for idx, row in activity_type.iterrows():
        ...
        kg2.add((iris['activity'], RDFS.isDefinedBy, ontologyIRI))
    ...
    for idx, row in serviceAreaType.iterrows():
        ...
        kg2.add((iris['serviceAreaType'], RDFS.isDefinedBy, ontologyIRI))
    return kg2
